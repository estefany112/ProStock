    ...
    <div class="bg-slate-800/40 border border-slate-700/70 rounded-3xl p-6 mb-6 overflow-hidden">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-5">
                ...
                {{-- ILUSTRACIÓN --}}
                <div class="hidden md:block w-40 lg:w-48 shrink-0" aria-hidden="true">
                    ...
                    <svg viewBox="0 0 400 220"
                        ...
                        <ellipse cx="200" cy="185" rx="150" ry="18"
                        ...
                        <line x1="183" y1="64" x2="183" y2="88"
                              stroke="#1E3A8A"
                              stroke-width="2"/>
                        ...
                        <ellipse cx="352" cy="112"
                                 rx="9"
                                 ry="7"
                                 fill="#FDE68A"/>

                        <ellipse cx="55" cy="118"
                                 rx="7"
                                 ry="6"
                                 fill="#F87171"/>
                ...
                <tbody
                    ...
                    @forelse($vehiculos as $vehiculo)
                        ...
                        <tr
                            ...
                            data-busqueda="{{ strtolower($vehiculo->placa.' '.$vehiculo->marca.' '.$vehiculo->modelo) }}">
...
(function () {
    ...
    const input = document.getElementById('buscador-vehiculos');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.form-eliminar-vehiculo').forEach(function (form) {
