...
<div class="max-w-7xl mx-auto mb-8">
    <div class="bg-gradient-to-r from-blue-900 to-slate-900 rounded-2xl p-8 border border-blue-800/50 shadow-xl relative overflow-hidden">
        ...
        <div class="absolute right-0 top-0 opacity-10 pointer-events-none">
            <svg class="w-64 h-64" viewBox="0 0 200 200"><path fill="currentColor" d="M44.7,-76.4C58.9,-69.2,71.9,-59.1,81.3,-46.8C90.7,-34.5,96.5,-20.1,97.5,-5.5C98.5,9.1,94.7,23.9,87.3,36.5C79.9,49.1,68.9,59.5,56.5,67.6C44.1,75.7,30.3,81.5,16.1,83.1C1.9,84.7,-12.7,82.1,-26.1,76.5C-39.5,70.9,-51.7,62.3,-61.7,51.8C-71.7,41.3,-79.5,28.9,-83.4,15.6C-87.3,2.3,-87.3,-11.9,-82.2,-24.5C-77.1,-37.1,-66.9,-48.1,-55.4,-57.1C-43.9,-66.1,-31.1,-73.1,-17.5,-78.7C-3.9,-84.3,10.5,-88.5,23.7,-86.7C36.9,-84.9,44.7,-76.4,44.7,-76.4Z"/></svg>
        </div>
    </div>
</div>
...
<div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    @php
        $stats = [
            ['title' => 'Stock de Insumos', 'value' => $stockTotal, 'desc' => 'Unidades en bodega', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>'],
            ['title' => 'Alertas de Stock', 'value' => $stockBajo, 'desc' => 'Repuestos críticos', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>'],
            ['title' => 'Personal Activo', 'value' => $totalEmpleados, 'desc' => 'Técnicos en campo', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>'],
        ];
    @endphp
...
<div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-slate-900 border border-slate-700 rounded-2xl p-6">
        <h2 class="text-lg font-semibold text-white mb-4">Acceso Administrativo</h2>
        <div class="space-y-3">
            <a href="{{ route('planillas.index') }}" class="flex items-center justify-between p-3 bg-slate-800 hover:bg-blue-600 hover:text-white rounded-xl transition text-slate-300">
                <span>Gestionar Planillas</span>
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
            </a>
            <a href="{{ route('admin.users') }}" class="flex items-center justify-between p-3 bg-slate-800 hover:bg-blue-600 hover:text-white rounded-xl transition text-slate-300">
