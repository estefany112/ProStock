...
>
    ...
    >
        ...
        @if(auth()->user()->hasAnyRole(['admin', 'ventas']))
            ...
            <div
                x-data="{
                    openComercial: {{ request()->routeIs('clientes.*') || request()->routeIs('cotizaciones.*') ? 'true' : 'false' }}
                }"
                class="space-y-1"
            >
        ...
        @if(auth()->user()->hasAnyRole(['admin', 'almacen']))
            ...
            <div
                x-data="{
                    open: {{ request()->routeIs('solicitudes.*')
                        || request()->routeIs('prostock.*')
        ...
        @if(auth()->user()->hasPermission('employee.view'))
            ...
            <div
                x-data="{
                    openEmp: {{ request()->routeIs('employees.*')
                        || request()->routeIs('planillas.*')
                        || request()->routeIs('horas-extras.*')
                        || request()->routeIs('anticipos.*')
                        ? 'true'
                        : 'false' }}
                }"
                class="space-y-1"
            >
                ...
                >
                    ...
                    <div class="pt-2">
                        ...
                        <div
                            x-data="{
                                openHE: {{ request()->routeIs('horas-extras.*') ? 'true' : 'false' }}
                            }"
                        >
                            ...
                            >
                                ...
                                <a
                                    href="{{ route('horas-extras.quincena') }}"
                                    class="block
                                           px-4
                                           py-1
                                           text-xs
                                           rounded-lg
                                           {{ request()->routeIs('horas-extras.quincena')
                                ...
                                <a
                                    href="{{ route('horas-extras.historial') }}"
                                    class="block
                                           px-4
                                           py-1
                                           text-xs
                                           rounded-lg
                                           {{ request()->routeIs('horas-extras.historial')
                                                ? 'text-white bg-slate-900'
                                                : 'text-slate-500 hover:text-slate-300' }}"
                                >
                                    Historial
                        ...
                        <div
                            x-data="{
                                openAnt: {{ request()->routeIs('anticipos.*') ? 'true' : 'false' }}
                            }"
                        >

                            <button
                                type="button"
                                @click="openAnt = !openAnt"
                                class="w-full
                                       flex
                                       items-center
                                       justify-between
                            ...
                            >
                                ...
                                <a
                                    href="{{ route('anticipos.quincena') }}"
                                    class="block
                                           px-4
                                           py-1
                                           text-xs
                                           rounded-lg
                                           {{ request()->routeIs('anticipos.quincena')
                                                ? 'text-white bg-slate-900'
                                                : 'text-slate-500 hover:text-slate-300' }}"
                                >
                                    Quincena
                                ...
                                <a
                                    href="{{ route('anticipos.historial') }}"
                                    class="block
                                           px-4
                                           py-1
                                           text-xs
                                           rounded-lg
                                           {{ request()->routeIs('anticipos.historial')
                                                ? 'text-white bg-slate-900'
                                                : 'text-slate-500 hover:text-slate-300' }}"
                                >
                                    Historial
