...
<body class="bg-slate-900"
        ...
        <div class="relative">
            ...
            <button
                ...
                <div class="text-right hidden sm:block">
                    ...
                    <p class="text-[10px] uppercase tracking-widest font-extrabold
                ...
                {{-- FOTO DE PERFIL --}}
                <div class="relative w-11 h-11 rounded-full overflow-hidden shadow-inner
                    ...
                    @else
                        ...
                        <div class="w-full h-full bg-gradient-to-br from-emerald-400 to-blue-500
            ...
            <div
                ...
                class="absolute right-0 mt-3 w-56 bg-white border border-slate-100
    ...
    <div class="flex pt-16 min-h-screen">
        ...
        {{-- SIDEBAR --}}
        <aside
            class="w-64 bg-slate-950 h-[calc(100vh-4rem)] overflow-y-auto
